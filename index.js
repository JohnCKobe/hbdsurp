function realisticConfetti() {
  ...
  function popTenTimes() {
    for (let i = 0; i < 10; i++) {
      ...
      }, i * 2000); // Adjust delay (in milliseconds) as needed
    }
  }
...
function celebrate() {
  displayBirthdayMessage(); // Display the birthday message
  playSound(); // Play the celebration sound
  realisticConfetti(); // Trigger the confetti effect
}

function displayBirthdayMessage() {
  var birthdayMessage = document.getElementById("birthdayMessage");
  birthdayMessage.style.display = "block"; // Display the birthday message
}
